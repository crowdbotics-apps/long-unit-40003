"""
Django settings for long_unit_40003 project.
...
ROOT_URLCONF = 'long_unit_40003.urls'
...
WSGI_APPLICATION = 'long_unit_40003.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "long_unit_40003 API",
    "DESCRIPTION": "API documentation for long_unit_40003 App",
    "VERSION": "v1",
}
